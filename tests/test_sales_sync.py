...
class SalesSyncTests(unittest.TestCase):
    ...
    def test_reviewed_structural_fab_sql_source_is_pinned(self):
        ...
        self.assertEqual(SOURCE, "dbo.SalesTransactions")
        self.assertIn("FROM dbo.SalesTransactions", TRANSACTION_SQL)
    ...
    def test_snapshot_counts_unique_invoices(self):
        ...
        self.assertEqual(snap["company"], "Structural Fab")
        self.assertEqual(snap["source_database"], "SFAB")
        self.assertEqual(snap["source_object"], "dbo.SalesTransactions")
