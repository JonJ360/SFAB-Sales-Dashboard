...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_freshness_and_sql_source_are_visible(self):
        ...
        self.assertIn("sfab_sales_snapshot_metadata", html)
    ...
    def test_unchanged_snapshot_heartbeat_is_atomic(self):
        ...
        self.assertIn("sfab_sales_heartbeat_snapshot", migration)
    ...
    def test_production_data_is_auth_gated_through_supabase(self):
        html = (ROOT / "index.html").read_text(encoding="utf-8")
        self.assertIn("sfab_sales_current_snapshot", html)
        self.assertNotIn("smi_sales_current_snapshot", html)
    ...
    def test_structural_fab_branding_is_visible(self):
        html = (ROOT / "index.html").read_text(encoding="utf-8")
        self.assertIn("<title>Structural Fab Sales</title>", html)
        self.assertIn('<div class="brand-mark">SFAB</div>', html)
        self.assertIn('<div class="eyebrow">Structural Fab</div>', html)
        self.assertNotIn('<div class="brand-mark">SMI</div>', html)
